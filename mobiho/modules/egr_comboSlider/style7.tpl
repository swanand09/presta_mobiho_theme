...
.lof-slidecontent .slider-description h4 {    font-size: 50px; font-weight:normal; margin:0; padding:30px 0 20px 0; }
.lof-slidecontent .slider-description p{ padding-left:35px; font-family:Arial, Helvetica, sans-serif; line-height:20px; font-size:13px;}
...
.lof-slidecontent ul.navigator-wrap-inner li img{
	border:[[SLIDE7-THUMB-BORDER]] solid 1px;
}
.lof-slidecontent ul.navigator-wrap-inner li.active img, 
.lof-slidecontent ul.navigator-wrap-inner li:hover img {
	border:[[SLIDE7-THUMB-BORDER-HOVER]] solid 1px;
}
...
.lof-slidecontent .navigator-content .button-next {
	...
	text-indent:-999px;
	margin-right:5px;
	background:url(../images/arrow7-l.png) no-repeat right center;
}
.lof-slidecontent .navigator-content .button-previous {	float:left; text-indent:-999px;	margin-left:5px; background:url(../images/arrow7-r.png) no-repeat left center;}
