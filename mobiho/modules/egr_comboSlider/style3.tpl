...
.lof-slidecontent ul.navigator-wrap-inner  li.active{
	background:url(../images/navigationArrow3.png) no-repeat scroll left center; 
	color:#FFF
}
...
.lof-slidecontent ul.navigator-wrap-inner li img{
	...
	float:left;
	padding:3px;
	border:[[SLIDE3-THUMB-INNER-BORDER]] solid 1px;
}
...
.lof-slidecontent   .button-next {
	right:250px;
	background:url(../images/arrow3-l.png) no-repeat right center;
	opacity:0.4;
	filter:alpha(opacity=40);
}
.lof-slidecontent  .button-previous {
	left:0px;
	background:url(../images/arrow3-r.png) no-repeat left center;
	opacity:0.4;
	filter:alpha(opacity=40);
}
