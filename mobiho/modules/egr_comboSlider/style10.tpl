...
.lof-slidecontent ul.navigator-wrap-inner  li.active{
	background:url(../images/navigationArrow10.png) no-repeat scroll left center; 
	color:#FFF
}
.lof-slidecontent ul.navigator-wrap-inner  li >  div{
	...
	margin-left:15px;
	padding-left:15px;
	border-top:1px solid [[SLIDE10-THUMB-BORDER]];
	text-align:left
}
.lof-slidecontent ul.navigator-wrap-inner  li h3{ font-size:18px; padding:5px 0 0 0; margin:0;}

.lof-slidecontent ul.navigator-wrap-inner li.active div{
	background:url(../images/navigationBg10.gif) left bottom;
	color:#000;
}
.lof-slidecontent ul.navigator-wrap-inner li img{
	...
	float:left;
	padding:3px;
	border:[[SLIDE10-THUMB-INNER-BORDER]]solid 1px;
}
...
.lof-slidecontent   .button-next {
	right:250px;
	background:url(../images/arrow10-r.png) no-repeat right center;
	opacity:0.4;
	filter:alpha(opacity=40);
}
.lof-slidecontent  .button-previous {
	left:0px;
	background:url(../images/arrow10-l.png) no-repeat left center;
	opacity:0.4;
	filter:alpha(opacity=40);
}
